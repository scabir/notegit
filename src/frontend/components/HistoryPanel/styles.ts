...
export const scrollContainerSx: SxProps<Theme> = { flexGrow: 1, overflow: 'auto' };
...
export const listItemSx = (selected: boolean, isDark: boolean): SxProps<Theme> => ({
  bgcolor: selected
    ? isDark
...
export const commitMetaSx: SxProps<Theme> = { display: 'flex', alignItems: 'center', gap: 1, mt: 1 };
export const hashChipSx: SxProps<Theme> = { height: 20, fontSize: '0.7rem', fontFamily: 'monospace' };
