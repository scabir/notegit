...
export const resultsContainerSx: SxProps<Theme> = { flexGrow: 1, overflow: 'auto', px: 1 };
export const centerStateSx: SxProps<Theme> = { p: 3, textAlign: 'center' };

export const resultItemSx = (selected: boolean, isDark: boolean): SxProps<Theme> => ({
...
export const moreChipSx: SxProps<Theme> = { mt: 0.5, height: 20, fontSize: '0.7rem' };
