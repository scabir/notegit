...
describe('SettingsDialog', () => {
  it('requests confirmation before switching profiles', () => {
    ...
    expect(confirmFn).toHaveBeenCalledWith('Switch to "My Profile"? The app will restart.');
  ...
  it('uses a fallback label when profile name is empty', () => {
    ...
    expect(confirmFn).toHaveBeenCalledWith('Switch to "this profile"? The app will restart.');
