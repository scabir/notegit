...
![Connect local repository](images/step-01-connect-local-repository.png)

## Step 2: Save local note

Create and save local note content before closing the app.

![Save local note](images/step-02-save-local-note.png)
...
![Reopen app and verify file exists](images/step-03-reopen-and-verify-file-list.png)

## Step 4: Confirm content persistence

Open the note after restart and confirm saved content is still available.

![Confirm content persistence](images/step-04-confirm-content-persistence.png)
