...
### macOS
- `notegit-2.0.0.dmg` - Drag-and-drop installer
- `notegit-2.0.0-mac.zip` - Portable archive
- Universal build (works on Intel and Apple Silicon)

### Windows
- `notegit Setup 2.0.0.exe` - Full installer
- `notegit 2.0.0.exe` - Portable executable
- Both 32-bit and 64-bit versions

### Linux
- `notegit-2.0.0.AppImage` - Universal Linux package
- `notegit_2.0.0_amd64.deb` - Debian/Ubuntu package
- `notegit-2.0.0.x86_64.rpm` - Red Hat/Fedora package
