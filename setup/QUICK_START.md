...
### macOS
- `notegit-1.3.6.dmg` - Drag-and-drop installer
- `notegit-1.3.6-mac.zip` - Portable archive
- Universal build (works on Intel and Apple Silicon)

### Windows
- `notegit Setup 1.3.6.exe` - Full installer
- `notegit 1.3.6.exe` - Portable executable
- Both 32-bit and 64-bit versions

### Linux
- `notegit-1.3.6.AppImage` - Universal Linux package
- `notegit_1.3.6_amd64.deb` - Debian/Ubuntu package
- `notegit-1.3.6.x86_64.rpm` - Red Hat/Fedora package
